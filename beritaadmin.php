...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="admin.php" class="logo">Kasun <span class="lite">Admin</span></a>
      <!--logo end-->
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="img/IMG-20190722-WA0020.jpg">
                            </span>
                            <span class="username">Kasun</span>
                            <b class="caret"></b>
                        </a>
...
<body bgcolor=#F5F5F5>
  ...
  <div id="profile">
     ...
     <b id="tambah"><a href="admin.php" class="btn btn-success ">Go Page</a></b>

     <center><b id="tambah"><a href="tambah.php" class="btn btn-success ">[+] Tambah Berita</a></b></center>
...
<h4 style="margin-bottom: 0px"><b><?php echo $data_berita['judul']; ?><b></h4><small>Ditulis oleh : <?php echo $data_berita['penulis']; ?>, pada : <?php echo $data_berita['tanggal_posting']; ?></small>
<p>
<?php 
...
<a href="berita_detil2.php?id=<?php echo $data_berita['id_berita']; ?>">selengkapnya</a>
